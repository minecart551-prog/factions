...
import io.icker.factions.command.BlockCommand;
...
public class FactionsMod implements ModInitializer {
    ...
    private static void registerCommands(CommandDispatcher<ServerCommandSource> dispatcher,
        ...
        Command[] commands = new Command[] {new AdminCommand(), new SettingsCommand(),
                ...
                new SacrificeCommand(), new WealthCommand(), new PermissionCommand(), new VassalCommand(), new BlockCommand(), new DimensionCommand()};
